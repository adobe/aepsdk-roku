...
function _adb_ServiceProvider() as object
    if GetGlobalAA()._adb_serviceProvider_instance = invalid then
        instance = {}
        ' add function pointers to the service provider singleton
        instance.loggingService = _adb_LoggingService()
        instance.networkService = _adb_NetworkService()
        instance.localDataStoreService = _adb_LocalDataStoreService()
