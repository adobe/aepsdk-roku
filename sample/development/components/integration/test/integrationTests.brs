    ...
    instance = {
        ...
        TC_SDK_createMediaSession: function() as dynamic
            ...
            validator[eventIdForCreateMediaSession] = sub(debugInfo)
                ' TODO: verify if the clientSessionId is stored correctly.
                ' debugInfo.media.clientSessionId
                ...
                ' TODO:
                ' ADB_assertTrue((debugInfo.networkRequests <> invalid and debugInfo.networkRequests.count() = 2), LINE_NUM, "assert ")
            end sub
        ...
        TC_SDK_sendMediaEventWhenSessionInactive: function() as dynamic
            ...
            eventIdForInactiveSession = aepSdk._private.lastEventId
            ...
            validator[eventIdForInactiveSession] = sub(debugInfo)
                ' TODO: verify if the clientSessionId is stored correctly.
                ' debugInfo.media.clientSessionId
                ADB_assertTrue((debugInfo <> invalid and debugInfo.apiName = "sendMediaEvent"), LINE_NUM, "assert debugInfo.apiName = sendMediaEvent")
                ' TODO:
